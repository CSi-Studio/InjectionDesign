...
import net.csibio.injection.client.constants.*;
...
@Slf4j
public abstract class ExcelManagerUtil<D extends MysqlBaseDO, Q extends PageQuery, S extends BaseService<D, Q>, V> extends AnalysisEventListener<V> {
