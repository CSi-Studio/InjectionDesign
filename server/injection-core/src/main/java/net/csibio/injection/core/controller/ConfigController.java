...
import net.csibio.injection.client.domain.vo.config.ConfigAddVO;
import net.csibio.injection.client.domain.vo.config.ConfigUpdateVO;
...
public class ConfigController extends BaseController<ConfigDO, ConfigQuery> {
    ...
    Result add(ConfigAddVO configAddVO) {
        checkIsNotNull(configAddVO.getConfigNo(), ResultCode.CONFIG_NO_CANNOT_BE_EMPTY);
        checkIsNotNull(configAddVO.getConfigName(), ResultCode.CONFIG_NAME_CANNOT_BE_EMPTY);
