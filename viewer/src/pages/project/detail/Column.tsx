...
import type {MsFileConvert} from "@/domains/MSFileConvert.d";
// @ts-ignore
...
export function buildProcessSampleColumn() {
  const columns: ProColumns<Sample>[] = [
    ...
    },
    {
      ...
      dataIndex: 'dim1',
      copyable: true,
      sorter: (a: any, b: any) => a.dim1.localeCompare(b.dim1),
    },
    {
      key: 'dim2',
      title: 'Dim2',
      dataIndex: 'dim2',
      copyable: true,
      sorter: (a: any, b: any) => a.dim2.localeCompare(b.dim2),
    },
    {
      key: 'dim3',
      title: 'Dim3',
      dataIndex: 'dim3',
      copyable: true,
      sorter: (a: any, b: any) => a.dim3.localeCompare(b.dim3),
    },
    {
      key: 'createDate',
