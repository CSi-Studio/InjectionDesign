          ...
          <Card title={'About Injection Design'}>
            ...
            <div style={{marginBottom: 32}}>
              <h3>
                ...
                2. The experimenter simply fills in the SampleID of each sample and the corresponding grouping, InjectionDesign supports up to three different grouping dimensions;<br/>
              ...
              <h3>
                ...
                3. <b>Direction</b>: The orientation of the sample layout;<br/>
                4. <b>QC Type</b>: The system currently supports 5 QC types: Blank, Long-Term Reference, Pooled, Solvent and Custom QC Samples;<br/>
